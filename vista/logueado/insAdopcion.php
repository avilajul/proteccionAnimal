...
{?>
	...
	<body class="">
		...
		<main>
			<h3  class="center-align green-text titulo">Inscribir Mascota para Adopción</h3>
			<div class="row">
				<form class="col s12 m6 l6" action="../../controlador/adopcion/adopcionCont.php" method="POST" enctype="multipart/form-data">
